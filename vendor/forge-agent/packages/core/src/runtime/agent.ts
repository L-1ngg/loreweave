...
export interface AgentOptions {
	...
	shouldStopAfterTurn?: ((context: ShouldStopAfterTurnContext, signal?: AbortSignal) => boolean | Promise<boolean>) | undefined;
	prepareNextTurn?: ((
		signal?: AbortSignal,
...
export class Agent {
	...
	private async runPromptMessages(
		...
		options: { skipInitialSteeringPoll?: (boolean) | undefined } = {},
	): Promise<void> {
	...
	private createLoopConfig(options: { skipInitialSteeringPoll?: (boolean) | undefined } = {}): AgentLoopConfig {
