...
for (const file of files) {
  ...
  if (file.startsWith("vendor/forge-agent/packages/")) continue;
  if (
    file.startsWith(".scratch/rag-v1/") &&
    file !== ".scratch/rag-v1/README.md"
  )
    continue;
...
if (failures.length) {
  ...
  console.log(
    `Checked ${checked} local links across ${files.length} Markdown files (historical snapshots excluded).`,
  );
}
